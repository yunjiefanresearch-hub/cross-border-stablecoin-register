...
1. [`pilot-enterprise-stablecoin-payment`](pilots/pilot-enterprise-stablecoin-payment.md) exercises current/reconciled controlled fixtures, human-review threshold and KYC conditions.
2. [`pilot-tokenized-green-asset-settlement`](pilots/pilot-tokenized-green-asset-settlement.md) exercises a controlled delivery-versus-payment request while explicitly excluding green taxonomy and securities-law claims.
